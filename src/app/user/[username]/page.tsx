  ...
  return (
    <main>
        ...
        <section className='container mx-auto px-5 md:px-0 my-12'>
          <div className='gap-4 mb-3 flex flex-col justify-center items-center md:flex-row md:justify-start'>
            <div>
              <Image
              src="/travel.jpg"
            ...
            <div className='flex flex-col gap-2'>
              <h1 className='xs:text-sm sm:text-lg md:text-2xl'>Shodiya Folorunsho - <span>@{finalUsername}</span> <span className='ml-2 bg-secondary text-white text-base py-1 px-2 rounded-sm shadow-sm'>Writer</span></h1>
              <p className='text-sm text-primary flex items-center justify-center md:justify-start'>51 posts<span className='font-bold text-lg mx-2 leading-10'>.</span>7.4k followers<span className='font-bold text-lg mx-2'>.</span>851 following</p>
